...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.commentDo.UseModel(&domain.Comment{})

	tableName := _comment.commentDo.TableName()
	_comment.ALL = field.NewAsterisk(tableName)
	_comment.ID = field.NewUint64(tableName, "id")
	_comment.TargetType = field.NewString(tableName, "target_type")
	_comment.TargetId = field.NewUint64(tableName, "target_id")
	_comment.AuthorId = field.NewUint64(tableName, "author_id")
	_comment.ParentId = field.NewUint64(tableName, "parent_id")
	_comment.RootId = field.NewUint64(tableName, "root_id")
	_comment.Depth = field.NewInt64(tableName, "depth")
	_comment.ReplyToUserId = field.NewUint64(tableName, "reply_to_user_id")
	_comment.Content = field.NewString(tableName, "content")
	_comment.Status = field.NewString(tableName, "status")
	_comment.ReviewReason = field.NewString(tableName, "review_reason")
	_comment.ReviewedBy = field.NewUint64(tableName, "reviewed_by")
	_comment.ReviewedAt = field.NewTime(tableName, "reviewed_at")
	_comment.Version = field.NewUint64(tableName, "version")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.RootId = field.NewUint64(table, "root_id")
	c.Depth = field.NewInt64(table, "depth")
	c.ReplyToUserId = field.NewUint64(table, "reply_to_user_id")
...
type ICommentDo interface {
	...
	Unscoped() ICommentDo
	Create(values ...*domain.Comment) error
	CreateInBatches(values []*domain.Comment, batchSize int) error
	Save(values ...*domain.Comment) error
	First() (*domain.Comment, error)
	Take() (*domain.Comment, error)
	Last() (*domain.Comment, error)
	Find() ([]*domain.Comment, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Comment, err error)
	FindInBatches(result *[]*domain.Comment, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*domain.Comment) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*domain.Comment, error)
	FirstOrCreate() (*domain.Comment, error)
	FindByPage(offset int, limit int) (result []*domain.Comment, count int64, err error)
...
func (c commentDo) Create(values ...*domain.Comment) error {
	if len(values) == 0 {
		return nil
	}
...
func (c commentDo) CreateInBatches(values []*domain.Comment, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c commentDo) Save(values ...*domain.Comment) error {
	if len(values) == 0 {
		return nil
	}
...
func (c commentDo) First() (*domain.Comment, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*domain.Comment), nil
	}
}

func (c commentDo) Take() (*domain.Comment, error) {
...
func (c commentDo) Last() (*domain.Comment, error) {
...
func (c commentDo) Find() ([]*domain.Comment, error) {
	result, err := c.DO.Find()
	return result.([]*domain.Comment), err
}

func (c commentDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Comment, err error) {
	buf := make([]*domain.Comment, 0, batchSize)
...
func (c commentDo) FindInBatches(result *[]*domain.Comment, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c commentDo) FirstOrInit() (*domain.Comment, error) {
...
func (c commentDo) FirstOrCreate() (*domain.Comment, error) {
...
func (c commentDo) FindByPage(offset int, limit int) (result []*domain.Comment, count int64, err error) {
...
func (c commentDo) Delete(models ...*domain.Comment) (result gen.ResultInfo, err error) {
